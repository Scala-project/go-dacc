 ...
 * API documentation: {@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md}.
 * @constructor
 *
 ...
 *
 * @return [nodeInfoObject]{@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#nodeinfo}
 *
 * @example
 * var admin = new Neb().admin;
 * //sync
 ...
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [accountsList]{@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#accounts}
 *
 * @example
 * var admin = new Neb().admin;
 * //sync
 ...
 * {@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#newaccount}
 *
 * @param {String} passphrase
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [address]{@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#newaccount}
 *
 * @example
 * var admin = new Neb().admin;
 * //sync
 ...
 * {@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#unlockaccount}
 *
 * @param {String} address
 * @param {String} passphrase
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [address]{@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#unlockaccount}
 *
 * @example
 * var admin = new Neb().admin;
 * //sync
...
/**
 * Method lock account.
 * {@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#lockaccount}
 *
 * @param {String} address
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [address]{@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#lockaccount}
 *
 * @example
 * var admin = new Neb().admin;
 * //sync
 ...
 * {@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#sendtransaction}
 *
 * @param {String} from
 * @param {String} to
 ...
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [Transcation hash and contract address]{@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#sendtransaction}
 *
 * @example
 * var admin = new Neb().admin;
 * //sync
...
/**
 * Method sign hash.
 * {@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#signhash}
 *
 * @param {String} address
 ...
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [data]{@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#signhash}
 *
 * @example
 * var admin = new Neb().admin;
 * //sync
 ...
 * {@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#signtransactionwithpassphrase}
 *
 * @param {String} from
 * @param {String} to
 * @param {Number|Sting} value
 ...
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [data]{@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#signtransactionwithpassphrase}
 *
 * @example
 * var admin = new Neb().admin;
 * //sync
 ...
 * {@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#sendtransactionwithpassphrase}
 *
 * @param {String} from
 * @param {String} to
 * @param {Number|Sting} value
 ...
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [data]{@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#sendtransactionwithpassphrase}
 *
 * @example
 * var admin = new Neb().admin;
 * //sync
...
/**
 * Method start listen provided port. {@link https://github.com/daccproject/go-dacc/blob/1bd9bc9c9c6ca4fa0d515b620aa096f7e1c45088/neblet/neblet.go#L159}<br>
 * TODO: Add parameter to wiki documentation.
 *
 * @param {String} [callback] - Listen port.
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [isListenStrted]{@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#stopmining}
 *
 * @example
 * var admin = new Neb().admin;
 * //sync
 ...
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [config]{@link https://github.com/daccproject/wiki/blob/master/rpc_admin.md#getConfig}
 *
 * @example
 * var admin = new Neb().admin;
 * //sync
 ...
 * API documentation: {@link https://github.com/daccproject/wiki/blob/master/rpc.md}.
 * @constructor
 *
 * @param {Neb} neb - Instance of Neb library.
 *
 ...
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [NebStateObject]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#getnebstate}
 *
 * @example
 * var api = new Neb().api;
 * //sync
 ...
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [NebStateObject]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#latestirreversibleblock}
 *
 * @example
 * var api = new Neb().api;
 * //sync
 ...
 * For more information about parameters, follow this link:
 * {@link https://github.com/daccproject/wiki/blob/master/rpc.md#getaccountstate}
 *
 * @param {String} address
 * @param {String} height
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [accaountStateObject]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#getaccountstate}
 *
 * @example
 * var api = new Neb().api;
 * //sync
 ...
 * For more information about parameters, follow this link:
 * {@link https://github.com/daccproject/wiki/blob/master/rpc.md#call}
 *
 * @param {String} from
 * @param {String} to
 * @param {Number|Sting} value
 ...
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [Transcation hash]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#call}
 *
 * @example
 * var api = new Neb().api;
 * //sync
 ...
 * For more information about parameters, follow this link:
 * {@link https://github.com/daccproject/wiki/blob/master/rpc.md#sendrawtransaction}
 *
 * @param {Object} data
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [Transcation hash]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#sendrawtransaction}
 *
 * @example
 * var api = new Neb().api;
 ...
 * For more information about parameters, follow this link:
 * {@link https://github.com/daccproject/wiki/blob/master/rpc.md#getblockbyhash}
 *
 * @param {String} hash
 * @param {Boolean} fullTransaction
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [Block]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#getblockbyhash}
 *
 * @example
 * var api = new Neb().api;
 * //sync
 ...
 * For more information about parameters, follow this link:
 * {@link https://github.com/daccproject/wiki/blob/master/rpc.md#getblockbyheight}
 *
 * @param {Number} height
 * @param {Boolean} fullTransaction
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [Block]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#getblockbyheight}
 *
 * @example
 * var api = new Neb().api;
 * //sync
 ...
 * For more information about parameters, follow this link:
 * {@link https://github.com/daccproject/wiki/blob/master/rpc.md#gettransactionreceipt}
 *
 * @param {String} hash
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [TransactionReceipt]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#gettransactionreceipt}
 *
 * @example
 * var api = new Neb().api;
 * //sync
 ...
 * For more information about parameters, follow this link:
 * {@link https://github.com/daccproject/wiki/blob/master/rpc.md#subscribe}
 *
 * @param {Array|String} topic
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [eventData]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#subscribe}
 *
 * @example
 * var api = new Neb().api;
 * //sync
 ...
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [Gas Price]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#getgasprice}
 *
 * @example
 * var api = new Neb().api;
 * //sync
 ...
 * For more information about parameters, follow this link:
 * {@link https://github.com/daccproject/wiki/blob/master/rpc.md#estimategas}
 *
 * @param {String} from
 * @param {String} to
 * @param {Number|Sting} value
 ...
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [Gas]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#estimategas}
 *
 * @example
 * var api = new Neb().api;
 * //sync
 ...
 * For more information about parameters, follow this link:
 * {@link https://github.com/daccproject/wiki/blob/master/rpc.md#geteventsbyhash}
 *
 * @param {String} hash
 * @param {Function} [callback] - Without callback return data synchronous.
 *
 * @return [Events]{@link https://github.com/daccproject/wiki/blob/master/rpc.md#geteventsbyhash}
 *
 * @example
 * var api = new Neb().api;
 * //sync
...
/**
 * Method getter for dpos dynasty.{@link https://github.com/daccproject/go-dacc/blob/0c3439f9cedc539f64f64dd400878d2318cb215f/rpc/api_service.go#L596}<br>
 * TODO: Add parameter to wiki documentation.
 *
 * @param {Function} [callback] - Without callback return data synchronous.
 *

...
func _license(_ *cli.Context) error {
	...
	In this way, we are still considering the license choice, which kind of license is the best for dacc ecosystem. We expect to select one of the LGPL v3, the Apache v2.0 or the MIT license. If the latter is chosen, it will come with an amendment allowing it to be used more widely.`)
	return nil
}

...
Mainnet is released, please check [here](https://github.com/daccproject/wiki/blob/master/mainnet.md) for more details.
...
```bash
cd $GOPATH/src
go get -u -v github.com/daccproject/go-dacc
```

The project is under active development. Its default branch is _develop_.

```bash
cd github.com/daccproject/go-dacc
```
...
> tips: more details about configuration, please refer to [`template.conf`](https://github.com/daccproject/wiki/blob/master/resources/conf/template.conf)
...
Please refer to our [contribution guideline](https://github.com/daccproject/wiki/blob/master/contribute.md) for more information.

Thanks.

## License

The go-dacc project is licensed under the [GNU Lesser General Public License Version 3.0 (“LGPL v3”)](https://www.gnu.org/licenses/lgpl-3.0.en.html).

For the more information about licensing, please refer to [Licensing](https://github.com/daccproject/wiki/blob/master/licensing.md) page.
